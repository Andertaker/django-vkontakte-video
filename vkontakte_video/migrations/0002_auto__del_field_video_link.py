...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'vkontakte_video_video', 'link')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Video.link'
        raise RuntimeError("Cannot reverse this migration. 'Video.link' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Video.link'
        db.add_column(u'vkontakte_video_video', 'link',
                      self.gf('django.db.models.fields.URLField')(max_length=255),
                      keep_default=False)
